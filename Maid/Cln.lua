...
local gethui = function() if gethui then return gethui() else return cloneref(UserSettings().GetService(game, 'CoreGui').RobloxGui) end; end; --// gay
--]]
...
--// Library init
	...
	writefile(Library.Directory.. '/Assets/Fonts/Proggy.ttf', HttpGet(game, 'https://github.com/1Ruke/Nihility/raw/refs/heads/main/Assets/Fonts/ProggyClean.ttf'));
	writefile(Library.Directory.. '/Assets/Images/Glow.Png', HttpGet(game, 'https://raw.githubusercontent.com/1Ruke/Nihility/refs/heads/main/Assets/Images/Glow.png'));
	writefile(Library.Directory.. '/Assets/Images/Icon1.Png', HttpGet(game, 'https://raw.githubusercontent.com/1Ruke/Nihility/refs/heads/main/Assets/Images/Icon1.png'));
	writefile(Library.Directory.. '/Assets/Images/Icon2.Png', HttpGet(game, 'https://raw.githubusercontent.com/1Ruke/Nihility/refs/heads/main/Assets/Images/Icon2.png'));
	writefile(Library.Directory.. '/Assets/Images/Icon3.Png', HttpGet(game, 'https://raw.githubusercontent.com/1Ruke/Nihility/refs/heads/main/Assets/Images/Icon3.png'));
	writefile(Library.Directory.. '/Assets/Images/Icon4.Png', HttpGet(game, 'https://raw.githubusercontent.com/1Ruke/Nihility/refs/heads/main/Assets/Images/Icon4.png'));
	writefile(Library.Directory.. '/Assets/Images/Icon5.Png', HttpGet(game, 'https://raw.githubusercontent.com/1Ruke/Nihility/refs/heads/main/Assets/Images/Icon5.png'));
	writefile(Library.Directory.. '/Assets/Images/White.Png', HttpGet(game, 'https://raw.githubusercontent.com/1Ruke/Nihility/refs/heads/main/Assets/Images/White.png'));
	...
	function Library:LoadConfig(ConfigJson)
		...
		for Key, Value in next, Config do 
			...
			if (not FunctionSet) then return end;
	...
	function Library:Resizeable(Frame)
		...
		local Resizing, OldSize, Start, StartSize = false, Frame.Size;
		local ResizePart = Library:Create('TextButton', {Position = Dim2(1, -10, 1, -10), BorderColor3 = FromRgb(0, 0, 0), Size = Dim2(0, 10, 0, 10), BorderSizePixel = 0, BackgroundColor3 = FromRgb(255, 255, 255), Parent = Frame, BackgroundTransparency = 1, Text = ''});
	...
	function Library:Panel(Options)
		...
		local Items = Cfg.Items do 
			--// Panel
			Items.GuiMain = Library:Create('GuiMain', {Enabled = true, Parent = gethui(), Name = ''});
			Items.MainHolder = Library:Create('Frame', {
				Parent = Items.GuiMain,
				-- Name = '',
		...
		Items.GuiMain:GetPropertyChangedSignal('Enabled'):Connect(function()
			Items.Icon.ImageColor3 = Items.GuiMain.Enabled and Themes[Library.UTheme].Accent or Themes[Library.UTheme].Inline
		end);

		Items.Button.MouseButton1Click:Connect(function()
			Items.GuiMain.Enabled = not Items.GuiMain.Enabled
		end);
	...
	function Library:TargetIndicator()
		...
		do 
			...
			Items.Label = Section:Label({Text = 'Player: '});
	...
	function Library:Watermark(Options) 
		local Cfg = {Default = Options.Text or Options.Default or os.os.date('Nihility.lol | %b %d %Y | %H:%M')};
	...
	function Library:Window(Properties)
		...
		local MainWindow = Library:Panel({
			Name = Properties and Properties.Name or 'Nihility.lol', 
		...
		Section:Label({Text = 'Accent'}):Colorpicker({Name = 'Accent', Color = Themes[Library.UTheme].Accent, Flag = 'Accent', Callback = function(Color) Library:UpdateTheme('Accent', Color) end});
		Section:Label({Text = 'Contrast'}):Colorpicker({Name = 'High', Color = Themes[Library.UTheme].HighContrast, Flag = 'HighContrast', Callback = function(Color)
		...
		Section:Label({Text = 'Inline'}):Colorpicker({Name = 'Inline', Color = Themes[Library.UTheme].Inline, Callback = function(Color)
			Library:UpdateTheme('Inline', Color)
		end; Flag = 'Inline'});

		Section:Label({Text = 'Outline'}):Colorpicker({Name = 'Outline', Color = Themes[Library.UTheme].Outline, Callback = function(Color)
			Library:UpdateTheme('Outline', Color)
		end; Flag = 'Outline'});

		Section:Label({Text = 'Text Color'}):Colorpicker({Name = 'Main', Color = Themes[Library.UTheme].Text, Callback = function(Color)
		...
		Section:Label({Text = 'Glow'}):Colorpicker({Name = 'Glow', Color = Themes[Library.UTheme].Glow, Callback = function(Color)
		...
		Section:Label({Text = 'UI Bind'}):Keybind({Flag = 'Menu Bind', Key = Enum.KeyCode.End, Callback = Window.SetMenuVisibility});
	...
	function Library:EspPreview(Properties)
		...
		if (not Client.Character.Archivable) then Client.Character.Archivable = true end;
		...
		local Items = Cfg.Items; do
			...
			Library:Connection(RunService.PostSimulation, function()
				if (not Library.MenuIsOpen and not Flags['Menu Spin Preview']) then Character.SetPrimaryPartCFrame(Character, NewCF(NewVect3(0, 0, -5)) * NewAnglesCF(Rad(5), Rad(180), 0)); return end;
				Cfg.Rotation += 0.75;
		...
		Cfg.ChangeHealth = function()
			if (Flags['HealthBar'] and Flags['HealthBar'].Parent ~= Objects['Holder']) then return end;
	...
	function Library:Notification(Properties)
		local Cfg = {Time = (Properties.Time or 5); Text = (Properties.Text or 'Notification');};
	...
	function Library:Tab(Options)	
		local Cfg = {Name = Options.Name or 'Tab'; Enabled = false;};
	...
	function Library:Section(Options)
		...
		ScrollingFrame:GetPropertyChangedSignal('CanvasPosition'):Connect(function()
			if (not Library.CurrentElementOpened) then return end;
			Library.CurrentElementOpened.SetVisible(false);
			Library.CurrentElementOpened.Open = false;
			Library.CurrentElementOpened = nil;
		end)
	...
	function Library:Slider(Options)
		...
		--// Instances 
			...
			if (not Cfg.InputDisabled) then Library:Hover(RealSlider, Slider); end;
	...
	function Library:Colorpicker(Options)
		...
		local DraggingSat, DraggingHue, H, s, v = false
		if (Cfg.Color) then H, s, v = (Cfg.Color:ToHSV()); else H, s, v = 0 end;
...
--[[
	...
	function Library:Dropdown(Options)
		...
		function Cfg:RefreshOptions(RefreshedList) 
			for _, v in next, Cfg.OptionInstances do v:Destroy() end;
	...
	function Library:List(Options)
		local Cfg = {
			...
			Scale = (Options.Size);
			Items = (Options.Items or {'1', '2', '3'});
			PlaceholderText = (Options.PlaceHolder or 'Search here...');
			Visible = (Options.Visible or true);
			OptionInstances = {};
			CurrentInstance = nil;
		...
		local List = Library:Create('Frame', {
			...
			Position = Dim2(0, 0, 0, 2),
			BorderColor3 = FromRgb(0, 0, 0),
			Size = Dim2(1, -27, 1, (Cfg.Scale or 232)),
			BorderSizePixel = 0,
			BackgroundColor3 = Themes[Library.UTheme].Outline
		});
	...
	function Library:Textbox(Options)
		...
		if (not Cfg.Default) then return end;
	...
	function Library:ButtonHolder(Options) 
		local Cfg = {Flag = (Options.Flag or '(ButtonHolder) EMPTY FLAG: '); Visible = (Options.Visible or true);};
	...
	function Library:Button(Options)
		local Cfg = {Callback = Options.Callback or function() end;  Name = (Options.Name or 'Button');};
	...
	function Library:Label(Options)
		local Cfg = {Name = (Options.Text or 'Label')};
	...
	function Library:Playerlist(Options) 
		local Cfg = {Callback = Options.Callback or function() end; Labels = {Name, Display, Uid};};
		...
		function Cfg.CreatePlayer(Player) 
			...
			if (not Players:FindFirstChild(PlayerName.Text)) then PlayerType.Text = 'Ai'; end;
			...
			TextButton.MouseButton1Click:Connect(function()
				...
				if (not Cfg.Labels.Name) then return end;
		...
		Cfg.Labels.Name = self:Label({Text = 'Name: ..?'});
		Cfg.Labels.Display = self:Label({Text = 'Display Name: ..?'});
		Cfg.Labels.Uid = self:Label({Text = 'User Id: ..?'});
